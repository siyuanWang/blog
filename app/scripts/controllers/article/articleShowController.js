...
define(['app'], function(app) {
    var controller = function($scope, $http, $routeParams, articleService, commentService, $window) {
    ...
    controller.inject = ['$scope', '$http', '$routeParams', 'articleService', 'commentService','$window'];
